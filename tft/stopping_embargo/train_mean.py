...
# -*- coding: utf-8 -*-
"""
TFT training script (stopping_embargo): mean-price (AMP) target.
...
def main() -> None:
    ...
    start_msg = (f"[train_mean][TFT stopping_embargo] Running on device: {device}")
    print(start_msg)
    ...
    with log_path.open("a", encoding="utf-8") as f:
        ...
        f.write(done_msg + "\n")
        f.write(f"[train_mean] [TFT stopping_embargo] Done on device: {device}\n")
