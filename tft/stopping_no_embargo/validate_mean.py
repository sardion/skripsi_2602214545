...
# -*- coding: utf-8 -*-
"""
Validation script for TFT (stopping_no_embargo): MEAN-price target.

Conventions aligned with LSTM/TFTLite:
- Deterministic DataLoader shuffling seed for parity
- y_min/y_max attach for mean price (metadata JSON → RAW fallback or AMP fallback)
...
def main() -> None:
    ...
    start_msg = f"[TFT stopping_no_embargo][validate_mean] Running on device: {device}"
    print(start_msg)
