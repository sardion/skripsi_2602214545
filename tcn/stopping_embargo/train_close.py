...
# -*- coding: utf-8 -*-
"""
TCN training script (stopping_embargo): close-price target.
...
def main() -> None:
    ...
    start_msg = (f"[train_close][TCN stopping_embargo] Running on device: {device}")
    print(start_msg)
    ...
    with log_path.open("a", encoding="utf-8") as f:
        ...
        f.write(done_msg + "\n")
        f.write(f"[train_close] [TCN stopping_embargo] Done on device: {device}\n")
