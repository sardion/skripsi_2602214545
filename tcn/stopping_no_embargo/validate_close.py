...
# -*- coding: utf-8 -*-
"""
Validation script for the TCN (stopping_no_embargo): CLOSE-price target.

Conventions aligned with LSTM validate_close.py:
...
def main() -> None:
    ...
    start_msg = f"[TCN stopping_no_embargo][validate_close] Running on device: {device}"
    print(start_msg)
