...
# -*- coding: utf-8 -*-
"""
LSTM training script (stopping_no_embargo): mean/AMP-price target.
...
def main() -> None:
    ...
    start_msg = (f"[train_mean][LSTM stopping_no_embargo] Running on device: {device}")
    print(start_msg)
    ...
    with log_path.open("a", encoding="utf-8") as f:
        ...
        f.write(done_msg + "\n")
        f.write(f"[train_mean] [LSTM stopping_no_embargo] Done on device: {device}\n")
