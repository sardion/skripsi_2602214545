...
# -*- coding: utf-8 -*-
"""
LSTM stopping_no_embargo: test script for CLOSE target (IDR-scale metrics).

This version matches train_close.py conventions:
...
def main() -> None:
    ...
    start_msg = f"[LSTM stopping_no_embargo][test_close] Running on device: {device}"
    print(start_msg)
